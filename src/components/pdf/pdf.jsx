        ...
        <View>
          ...
          <View id="document-changes" className="document_changes page-break">
            ...
            <Table>
              <Table.Header>
               < Table.Row>
                  <Table.Header style={{ textAlign: "center" }}>Date</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>PCI DSS Version</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>SAQ Revision</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>Description</Table.Header>
                </Table.Row>
              </Table.Header>
              <Table.Body>
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>October 2008</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>1.2</Table.Cell>
                  <Table.Cell />
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>October 2010</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>2.0</Table.Cell>
                  <Table.Cell />
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>February 2014</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.0</Table.Cell>
                  <Table.Cell />
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>April 2015</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.1</Table.Cell>
                  <Table.Cell />
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>July 2015</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.1</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>1.1</Table.Cell>
                  <Table.Cell>Updated version numbering to align with other SAQs.</Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>April 2016</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.2</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>1.0</Table.Cell>
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>January 2017</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.2</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>1.1</Table.Cell>
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>June 2018</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.2.1</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>1.0</Table.Cell>
                  <Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell style={{ textAlign: "center" }}>September 2022</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>3.2.1</Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>2.0</Table.Cell>
                  <Table.Cell>
          ...
          >
            ...
            <Table>
              <Table.Header>
                <Table.Row>
                  <Table.Header>Table of Contents</Table.Header>
                </Table.Row>
              </Table.Header>
              <Table.Body>
                <Table.Row>
          ...
          <View className="PCI DSS page-break" id="pci-dss-self-assessment">
            ...
            <Table>
              <Table.Header>
                <Table.Row>
                  <Table.Header style={{ backgroundColor: "#384d59", color: "#fff" }}>
                    Document
                  </Table.Header>
                  <Table.Header style={{ backgroundColor: "#384d59", color: "#fff" }}>
                    Includes
              ...
              <Table.Body>
                ...
                <Table.Row></Table.Row>
                <Table.Row>
                  <Table.Cell>SAQ Instructions and Guidelines documents</Table.Cell>
                  <Table.Cell>
                    <li>
              ...
              <Table.Body>
                ...
                <Table.Row>
                  ...
                  <Table.Cell>
                    ...
                    Compensating ConTable.Rowol Worksheet (CCW) in Appendix B of the SAQ.
          ...
          <View style={{ marginTop: "100px" }} className="section_1 page-break">
            ...
            <View className="part1">
              <Table>
                <Table.Body>
                  <Table.Row style={{ backgroundColor: "#006c73" }}>
                    <Table.Header className="bg" colSpan={6}>
                      <Text>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell >{allData && allData[0]?.partResponse}</Table.Cell>
                    <Table.Cell>DBA (doing business as):</Table.Cell>
                    <Table.Cell colSpan={4}>{allData && allData[1]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Contact Name:</Table.Cell>
                    <Table.Cell>{allData && allData[2]?.partResponse}</Table.Cell>
                    <Table.Cell>Title:</Table.Cell>
                    <Table.Cell colSpan={6}>{allData && allData[3]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Telephone:</Table.Cell>
                    <Table.Cell>{allData && allData[4]?.partResponse}</Table.Cell>
                    <Table.Cell>E-mail:</Table.Cell>
                    <Table.Cell colSpan={4}>{allData && allData[5]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Business Address:</Table.Cell>
                    <Table.Cell>{allData && allData[11]?.partResponse}</Table.Cell>
                    <Table.Cell colSpan={1}>City:</Table.Cell>
                    <Table.Cell colSpan={4}>{allData && allData[8]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>State/Province:</Table.Cell>
                    <Table.Cell>{allData && allData[7]?.partResponse}</Table.Cell>
                    <Table.Cell>Country</Table.Cell>
                    <Table.Cell>{allData && allData[6]?.partResponse}</Table.Cell>
                    <Table.Cell>Zip</Table.Cell>
                    <Table.Cell>{allData && allData[10]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>URL: </Table.Cell>
                    <Table.Cell colSpan={5}>{allData && allData[9]?.partResponse}</Table.Cell>
                  </Table.Row>
                </Table.Body>
              </Table>
              <Table>
                ...
                <Table.Body>
                  <Table.Row>
                    <Table.Cell>Company Name:</Table.Cell>
                    <Table.Cell colSpan={5}>{allData && allData[0]?.partResponse}</Table.Cell>
  
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Lead QSA Contact Name:</Table.Cell>
                    <Table.Cell>{allData && allData[2]?.partResponse}</Table.Cell>
                    <Table.Cell>Title: </Table.Cell>
                    <Table.Cell colSpan={3}>{allData && allData[3]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Telephone:</Table.Cell>
                    <Table.Cell>{allData && allData[4]?.partResponse}</Table.Cell>
                    ...
                    <Table.Cell>E-mail:</Table.Cell>
                    <Table.Cell colSpan={3}>{allData && allData[5]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Business Address:</Table.Cell>
                    <Table.Cell colSpan={2}>{allData && allData[11]?.partResponse}</Table.Cell>
                    <Table.Cell colSpan={1}>City:</Table.Cell>
                    <Table.Cell colSpan={4}>{allData && allData[8]?.partResponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    ...
                    <Table.Cell>{allData && allData[6]?.partResponse}</Table.Cell>
                    <Table.Cell>Zip</Table.Cell>
                    <Table.Cell>{allData && allData[10]?.parTable.Rowesponse}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>URL: </Table.Cell>
                    <Table.Cell colSpan={5}>{allData && allData[9]?.partResponse}</Table.Cell>
            ...
            <View className="part2">
              <Table>
                <Table.Header>
                  <Table.Row>
                    <Table.Header className="bg" colSpan={4}>
                ...
                <Table.Body>
                  ...
                  <Table.Row>
                    <Table.Cell rowSpan={3} colSpan={2}>
              ...
              <View className="page-break">
                ...
                <Table>
                  <Table.Header>
                    <Table.Row>
                      <Table.Header colSpan={4}>Part 2c. Locations</Table.Header>
                    </Table.Row>
                  </Table.Header>
                  <Table.Body>
                    <Table.Row>
                    ...
                    <Table.Row>
                      <Table.Header>Type of facility</Table.Header>
                      <Table.Header>Number of facilities of Table.Headeris type</Table.Header>
                      <Table.Header>Location(s) of facility (city, country)</Table.Header>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                        <p>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>Mention numbers of Facility Locations</Table.Cell>
                      <Table.Cell>Mention in Facility Locations</Table.Cell>
                    </Table.Row>
                    <Table.Row>
                    <Table.Cell>{allData && allData[14]?.partResponse && JSON.parse(allData[14].partResponse).type}</Table.Cell>
                    <Table.Cell>{allData && allData[14]?.partResponse && JSON.parse(allData[14].partResponse).number}</Table.Cell>
                    <Table.Cell>{allData && allData[14]?.partResponse && JSON.parse(allData[14].partResponse).location}</Table.Cell>
                ...
                <Table>
                  <Table.Headeread>
                    <Table.Row>
                      <Table.Header colSpan={5}>Part 2d. Payment Application</Table.Header>
                    </Table.Row>
                  </Table.Headeread>
                  <Table.Body>
                    <Table.Row>
                    ...
                    <Table.Row style={{ backgroundColor: "rgb(203, 213, 212)" }}>
                      <Table.Cell>
                    ...
                    <Table.Row>
                    <Table.Cell>{allData && allData[15]?.partResponse && JSON.parse(allData[15].partResponse).name}</Table.Cell>
                    <Table.Cell>{allData && allData[15]?.partResponse && JSON.parse(allData[15].partResponse).version}</Table.Cell>
                    <Table.Cell>{allData && allData[15]?.partResponse && JSON.parse(allData[15].partResponse).vendor}</Table.Cell>                    <Table.Cell style={{ textAlign: "center" }}>
                        <input type="checkbox" checked /> Yes
                        <input type="checkbox" /> No
                      </Table.Cell>
                      <Table.Cell>{allData && allData[15]?.partResponse && JSON.parse(allData[15].partResponse).expiryDate}</Table.Cell>                  </Table.Row>
                    <Table.Row>
                      <Table.Cell></Table.Cell>
                      <Table.Cell></Table.Cell>
                      <Table.Cell></Table.Cell>
                ...
                <Table>
                  <Table.Headeread>
                    <Table.Row>
                      <Table.Header colSpan={4}>Part 2e. Description of Environment</Table.Header>
                    </Table.Row>
                  </Table.Headeread>
                  <Table.Body>
                    <Table.Row>
              ...
              <Table className="page-break">
                <Table.Headeread>
                  ...
                  <Table.Row>
                    <Table.Header colSpan={4}>Part 2f. Third-Party Service Providers</Table.Header>
                  </Table.Row>
                </Table.Headeread>
                <Table.Body>
                  <Table.Row>
                    ...
                    <Table.Cell colSpan={2} style={{ width: "11%" }}>
                      <input type="checkbox" /> Yes{" "}
                      <input type="checkbox" defaultChecked /> No
                    </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Header colSpan={4} style={{ backgroundColor: "grey" }}>
                      If Yes:
                    </Table.Header>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Name of QIR Company:</Table.Cell>
                    <Table.Cell colSpan={3} />
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>QIR Individual Name:</Table.Cell>
                    <Table.Cell colSpan={3} />
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>Description of services provided by QIR:</Table.Cell>
                    <Table.Cell colSpan={3} />
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell colSpan={2}>
                  ...
                  <Table.Row>
                    <Table.Cell>Name of service provider:</Table.Cell>
                    <Table.Cell colSpan={2}>Description of services provided:</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                  <Table.Cell>{allData && allData[20]?.partResponse && JSON.parse(allData[20].partResponse).name}</Table.Cell>   
                  <Table.Cell colSpan={2}>{allData && allData[20]?.partResponse && JSON.parse(allData[20].partResponse).description}</Table.Cell>                </Table.Row>
                  <Table.Row>
                    <Table.Cell />
                    <Table.Cell colSpan={2} />
                  </Table.Row>
              ...
              <Table>
                <Table.Headeread>
                  <Table.Row>
                    <Table.Header>Part 2g. Eligibility to Complete SAQ A</Table.Header>
                  </Table.Row>
                </Table.Headeread>
                <Table.Body>
                  <Table.Row>
                  ...
                  {/* <tr><Table.Cell> <input type="checkbox" checked/>Additionally, for e-commerce channels:  */}
                  {/* </Table.Cell></tr> */}
                  <Table.Row>
                    <Table.Cell>
                      {" "}
          ...
          <View style={{ marginTop: "130px" }} className="page-break">
            ...
            <Table>
              <Table.Headeread>
                ...
                <Table.Row>
                  <Table.Header style={{ textAlign: "center" }}>Yes</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>Yes wiTable.Header CCW</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>No</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>N/A</Table.Header>
                </Table.Row>
              </Table.Headeread>
              <Table.Body>
                <Table.Row>
                  ...
                  <Table.Cell style={{ textAlign: "center", width: "6%" }}>
                    <input type="checkbox" />
                  </Table.Cell>
                  <Table.Cell style={{ textAlign: "center" }}>
                    <input type="checkbox" />
            ...
            <View className="page-break">
              ...
              <Table>
                <Table.Headeread>
                  ...
                  <Table.Row>
                    <Table.Header style={{ textAlign: "center" }}>Yes</Table.Header>
                    <Table.Header style={{ textAlign: "center", width: "70px" }}>
                      Yes with CCW
                    </Table.Header>
                    <Table.Header style={{ textAlign: "center" }}>No</Table.Header>
                    <Table.Header style={{ textAlign: "center" }}>N/A</Table.Header>
            ...
            <View className="page-break">
              ...
              <Table>
                ...
                <Table.Body>
                  ...
                  <Table.Row>
                    <Table.Cell rowSpan={2}>9.6</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                  ...
                  <Table.Row>
                    <Table.Cell />
                    <Table.Cell>(b) Do controls include the following:</Table.Cell>
                    <Table.Cell colSpan={5} />
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>9.6.1</Table.Cell>
                    <Table.Cell>
            ...
            <Table className="page-break">
              <Table.Headeread>
                ...
                <Table.Row>
                  <Table.Header style={{ textAlign: "center" }}>Yes</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>Yes with CCW</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>No</Table.Header>
                  <Table.Header style={{ textAlign: "center" }}>N/A</Table.Header>
                </Table.Row>
              </Table.Headeread>
              <Table.Body>
                ...
                <Table.Row>
                  <Table.Cell rowSpan={2}>9.8</Table.Cell>
                ...
                <Table.Row>
                  <Table.Cell>(c) Is media destruction performed as follows:</Table.Cell>
                  <Table.Cell colSpan={5} />
                </Table.Row>
                <Table.Row>
                  <Table.Cell rowSpan={2}>9.8.1</Table.Cell>
                  <Table.Cell rowSpan={1}>
              ...
              <Table>
                <Table.Headeread>
                  ...
                  >
                    ...
                    <Table.Cell>Reason Requirement is Not Applicable</Table.Cell>
                  </Table.Row>
                </Table.Headeread>
                <Table.Body>
                  <Table.Row>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>Cardholder data is never stored electronically </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>9.5</Table.Cell>
                    <Table.Cell>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>
                      ...
                      disTable.Rowibution of media having cardholder data.{" "}
                    </Table.Cell>
                  </Table.Row>{" "}
                  <Table.Row>
                    <Table.Cell>9.6.2</Table.Cell>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>
                      This requirement is not applicable since the cardholder data
                      is not being stored. Hence desTable.Rowuction of media does not
                      take place.
                    </Table.Cell>
                  </Table.Row>{" "}
                  <Table.Row>
                    <Table.Cell>9.8.1</Table.Cell>
                    <Table.Cell>
                      This requirement is not applicable since the cardholder data
                      is not being stored.{" "}
                    </Table.Cell>
            ...
            <View style={{ marginTop: "120px" }} className="page-break">
              ...
              <Table>
                <Table.Headeread></Table.Headeread>
                <Table.Body>
                  <Table.Row>
                    <Table.Cell>
                      <input type="checkbox" defaultChecked />
                  ...
                  <Table.Row>
                    <Table.Cell colSpan={2}>
                      <Table>
                        <Table.Headeread>
                          <Table.Row>
                            <Table.Header>Affected Requirement</Table.Header>
                            <Table.Header>
              ...
              <Table>
                <Table.Headeread>
                  <Table.Row>
                    <Table.Header colSpan={2}>Part 3a. Acknowledgement of Status</Table.Header>
                  </Table.Row>
                  <Table.Row>
                    <Table.Header
                      colSpan={2}
                    ...
                    >
                      ...
                      <br />
                      <i>(Check all Table.Headerat apply)</i>
                    </Table.Header>
                  </Table.Row>
                </Table.Headeread>
                <Table.Body>
              ...
              <View className="page-break">
                ...
                <Table>
                  <Table.Headeread>
                    <Table.Row>
                      <Table.Header colSpan={2}>Part 3b. Merchant Attestation</Table.Header>
                    </Table.Row>
                    <Table.Row>
                      <Table.Header
                        colSpan={2}
                  ...
                  <Table.Body>
                    <Table.Row>
                      ...
                      <Table.Cell>
                        <i>Date:</i>
                        <span>{allData && allData[21]?.submissionDate}</span></Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        {" "}
                        <i>Title: </i><span >{allData && allData[21]?.partResponse && JSON.parse(allData[21].parTable.Rowesponse).executiveTitle}</span>   
                      </Table.Cell>
                    </Table.Row>
                  </Table.Body>
                </Table>
              ...
              <View className="page-break">
                ...
                <Table style={{ marginTop: "-12px" }}>
                  <Table.Headeread>
                    <Table.Row>
                      <Table.Header rowSpan={2} style={{ textAlign: "center" }}>
                        PCI DSS Requirement*
                      </Table.Header>
                      <Table.Header rowSpan={2} style={{ textAlign: "center" }}>
                  ...
                  <Table.Body>
                    <Table.Row>
                      <Table.Cell style={{ textAlign: "center" }}>2</Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      <Table.Cell style={{ textAlign: "center" }}>6</Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      <Table.Cell style={{ textAlign: "center" }}>8</Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      <Table.Cell style={{ textAlign: "center" }}>9</Table.Cell>
                      <Table.Cell>Restrict physical access to cardholder data</Table.Cell>
                      <Table.Cell style={{ textAlign: "center" }}>
                        <input type="checkbox" defaultChecked />
                      </Table.Cell>
                      <Table.Cell style={{ textAlign: "center" }}>
                    ...
                    <Table.Row>
                      <Table.Cell style={{ textAlign: "center" }}>12</Table.Cell>
                      <Table.Cell>
