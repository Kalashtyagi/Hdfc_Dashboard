...
const fetchData = async (pdfData, setAllData) => {
  ...
  const fetchImage = async (setApiImage) => {
...
const MyDocument = ({allData,apiImage}) => ( 
  <Document>
...
const handleDownloadPdf = async (allData,apiImage) => {
  const blob = await pdf(<MyDocument allData={allData} apiImage={apiImage} />).toBlob();
...
export default function Pdf() {
  ...
  useEffect(() => {
    ...
    fetchImage(setApiImage) // Call fetchData here
  }, [pdfData])
  // useEffect(() => {
